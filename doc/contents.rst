...
- A `PDF <../latex/opencv.pdf>`_ version of |opencv| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:opencv:opencv>`__ wiki.
